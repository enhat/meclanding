...
//     if (currentTime - lastUpdateRef.current < frameIntervalRef.current) return;
//     lastUpdateRef.current = currentTime;

//     if (!disableAnimation) {
//       // Smooth looping using cosine easing
//       const t = clock.getElapsedTime();
//       const progress = (t % loopDuration) / loopDuration;
//       const smoothTime =
//         loopDuration * 0.5 * (1 - Math.cos(2 * Math.PI * progress));
//       waveUniformsRef.current.time.value = smoothTime;
//     }
...
//       </mesh>
//       <EffectComposer>
//         <RetroEffect ref={effect} colorNum={colorNum} pixelSize={pixelSize} />
//       </EffectComposer>
//       <mesh
